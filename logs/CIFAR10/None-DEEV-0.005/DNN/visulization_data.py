...
df_deev = pd.read_csv(r'D:\Documentos\Estudos\Mestrado\Aprendizado Federado\DEEV-main\DEEV-main\logs\CIFAR10\None-DEEV-0.005\DNN\server.csv', header=None, names=['timestamp', 'round', 'loss', 'accuracy', 'top5'])
...
# Salvar e mostrar
plt.tight_layout()
plt.savefig('grafico_deev_final_CIFAR10.png', dpi=300)
plt.show()