...
df_deev = pd.read_csv(r'D:\Documentos\Estudos\Mestrado\Aprendizado Federado\DEEV-main\DEEV-main\logs\MNIST\None-DEEV-0.005\DNN\server.csv', header=None, names=['timestamp', 'round', 'loss', 'accuracy', 'top5'])
